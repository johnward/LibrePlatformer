...
#include <FTGL/ftgl.h>			// text drawing
...
float lastCameraPosX;				// Last camera position frshareom view()
...
string fontName = "/usr/share/fonts/truetype/freefont/FreeSans.ttf";
